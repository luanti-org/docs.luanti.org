...
- [Starting from 5.13.0](https://github.com/luanti-org/luanti/pull/16803), it is possible to specify secondary keybindings for a single action by delimiting the key names with a pipe character(`|`). The action is activated if any of the keys is pressed down.
